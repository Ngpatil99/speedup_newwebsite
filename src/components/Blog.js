  ...
  return (
    <div className="container-fluid py-5 main-blog-bg">
      ...
      <div className="row blog-card-row">
        <div className="col-lg-3 col-md-3 col-sm-12 lower_cards card1_container">
          <div className="card px-3 shadow-sm card1-bg">
            <div className="card-body">
              <p className="card-title our_expertise pt-4 pb-2">
              Latest
              </p>
        ...
        <div className="col-lg-3 col-md-3 col-sm-12 mt-4 card2_container">
        ...
        <div className="col-lg-3 col-md-3 col-sm-12 lower_cards card3_container">
        ...
        <div className="col-lg-3 col-md-3 col-sm-12 mt-4 card4_container">
          <div className="card px-3 shadow-sm card4-bg">
            <div className="card-body">
              <p className="card-title our_expertise pt-4 pb-2">
              1 month ago
              </p>
            ...
            <div className="position-absolute top-0 end-0 p-2 m-3 rounded-circle bg-light">
              <svg
                ...
                className="zoom-out"
              >
                <g transform="translate(-360.551 -1791)">
                  <path
                    className="st0"
                    d="M390.2,1850h12c4,0,7.2-3.2,7.2-7.2v-7.2"
                  ></path>
                  <path
                    className="st1"
                    d="M373.5,1823.7h-12v12c0,2.6,2.1,4.8,4.8,4.8l0,0h7.2V1823.7z"
                  ></path>
                  <path
                    className="st1"
                    d="M409.4,1823.7h-12v16.7h7.2c2.6,0,4.8-2.1,4.8-4.8l0,0V1823.7z"
                  ></path>
                  <path
                    className="st1"
      ...
      <div className="row blog-card-row">
        <div className="col-lg-3 col-md-3 col-sm-12 card5_container">
        ...
        <div className="col-lg-3 col-md-3 col-sm-12 lower_cards2 card6_container">
        ...
        <div className="col-lg-3 col-md-3 col-sm-12 card7_container">
        ...
        <div className="col-lg-3 col-md-3 col-sm-12 lower_cards2 card8_container">
          <div className="card px-3 card8-bg">
            <div className="card-body">
              <p className="card-title our_expertise pt-4 pb-2">
                2 week ago
              </p>
